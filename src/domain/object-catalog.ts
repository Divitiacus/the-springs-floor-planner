...
export const OBJECT_CATALOG: ObjectDefinition[] = [
  ...
  { type: "round-table-72", name: "72-inch Round Table", shortLabel: "72\" Round", category: "Tables", width: 108, height: 108, defaultSeats: 10, resizable: false, icon: "round" },
...
export function isGuestTable(type: EventObjectType) {
  return type === "round-table-60" || type === "round-table-72" || type === "rectangle-table-6";
}
